...
- Inline edit panels on every entity (expand under the list item, no popup dialogs), with Save/Cancel and inline error messages
- Delete actions on every entity
- Data is loaded directly from the Spring Boot REST API

## Planned Features

- Form validation on all entities (currently only movie title/rating are validated)
...
- React frontend integration, with inline edit panels and delete for every entity

Future development will focus on broader request validation and authentication.
